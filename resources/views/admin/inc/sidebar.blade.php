        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="{{ route('admin.categories.index') }}" class="dropdown-item">ALL</a>
                    <a href="{{ route('admin.categories.create') }}" class="dropdown-item">ADD</a>
                </div>
            </div>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Product</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="{{ route('admin.products.index') }}" class="dropdown-item">ALL</a>
                    <a href="{{ route('admin.products.index') }}" class="dropdown-item">ADD</a>
                </div>
            </div>
            <a href="{{ route('admin.orders.index') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Order</a>
